...
<main class="main-content page-transition page-content">
    ...
    <div class="container">
        ...
        <section class="comments-section">
            ...
            <?php else: ?>
                <p class="login-prompt">Please <a href="/blog-application/pages/login.php">login</a> to leave a comment.</p>
            <?php endif; ?>
...
async function loadBlog() {
    try {
        const response = await fetch(`/blog-application/api/blog/read.php?id=${blogId}`);
            ...
            if (currentUserId === blog.user_id) {
                actionsHtml = `
                    <div class="blog-actions">
                        <a href="/blog-application/pages/edit-blog.php?id=${blog.id}" class="btn btn-secondary">Edit</a>
...
async function loadComments() {
    try {
        const response = await fetch(`/blog-application/api/blog/comments.php?blog_id=${blogId}`);
        const data = await response.json();
...
document.getElementById('commentForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const response = await fetch('/blog-application/api/blog/comments.php', {
            method: 'POST',
            body: formData
        });
...
async function deleteBlog(blogId) {
    ...
    try {
        ...
        if (data.success) {
            alert(data.message);
            setTimeout(() => {
                window.location.href = '/blog-application/pages/dashboard.php';
            }, 1500);
        } else {
            alert(data.message);
        }
