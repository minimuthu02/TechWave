...
<main class="main-content page-transition page-content">
    <div class="container">
        ...
        <section class="featured-blogs">
                    ...
                    <?php foreach ($blogs as $blog): ?>
                        <div class="featured-card">
                            <div class="featured-card-image">
                                <?php 
                                $imageSrc = !empty($blog['image']) ? $blog['image'] : '/assets/images/blog-placeholder.jpg';
                                ?>
            ...
            <?php else: ?>
                <div class="no-posts-message">
                    ...
                    <?php if (isLoggedIn()): ?>
                        <a href="/pages/create-blog.php" class="btn btn-primary">Create First Post</a>
                    <?php else: ?>
                        <a href="/pages/index.php" class="btn btn-secondary">Browse All Blogs</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </section>
        ...
        <div style="text-align: center; margin: 3rem 0;">
            <a href="/pages/index.php" class="btn btn-secondary">← Back to All Blogs</a>
        </div>
    </div>
</main>
