        ...
        <div class="footer-container">
            <div class="footer-content">
                ...
                <div class="footer-brand">
                    <h3>TechWave</h3>
                    <p>Riding the next wave of innovation and discovery</p>
                ...
                <div class="footer-links-group">
                    <h4>Quick Links</h4>
                    <ul>
                        <li><a href="/blog-application/pages/index.php">Home</a></li>
                        <li><a href="/blog-application/pages/dashboard.php">Dashboard</a></li>
                        <li><a href="/blog-application/pages/create-blog.php">Create Blog</a></li>
    ...
    <!-- Conditional Scripts -->
    <?php if (isset($includeAuthJS) && $includeAuthJS): ?>
        <script src="<?php echo asset('js/auth.js'); ?>"></script>
    <?php endif; ?>

    <?php if (isset($includeBlogJS) && $includeBlogJS): ?>
        <script src="<?php echo asset('js/blog.js'); ?>"></script>
    <?php endif; ?>
</body>
</html>
