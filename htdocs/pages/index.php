<?php
// Include bootstrap file for app initialization (database, helpers, constants, etc.)
require_once '../config/bootstrap.php';

// Start PHP session if not already active (used to store user login data)
...
// Retrieve current logged-in user's ID, or 0 if not logged in
...
try {
    ...
    // Prepare and execute featured query
...
<main class="main-content page-transition page-content">
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <div class="hero-cta">
                ...
                <?php else: ?>
                    <a href="/pages/create-blog.php" class="btn btn-primary">Create Blog</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <?php if ($featuredBlog):
        // Safely handle empty image fields 
        ...
        // Like information and icon selection
        ...
        <div class="featured-blog">
            ...
            <div class="featured-blog-content">
                ...
                <div class="featured-blog-actions">
                    ...
                    <a href="/pages/view-blog.php?id=<?php echo $featuredBlog['id']; ?>" 
    ...
    <div class="container">
        ...
        <section class="featured-blogs">
            <?php if (!empty($blogs)): ?>
                <div class="blog-cards-grid">
                    <!-- Loop through and display each blog card -->
                    <?php foreach ($blogs as $blog): 
                        $imageSrc = !empty($blog['image']) 
                            ? $blog['image'] 
                            : '/assets/images/blog-placeholder.jpg';
                            
                            // Create a safe content snippet (shortened)
                    ...
                    ?>
                        <div class="blog-card" data-blog-id="<?php echo $blog['id']; ?>">
                            ...
                            <div class="blog-card-content">
                                <h3>
                                    <a href="/pages/view-blog.php?id=<?php echo $blog['id']; ?>">
            ...
            <?php else: ?>
                ...
                <div class="no-posts-message">
                    ...
                    <?php if (isLoggedIn()): ?>
                        <a href="/pages/create-blog.php" class="btn btn-primary">Create Your First Post</a>
                    <?php else: ?>
                        <a href="/pages/register.php" class="btn btn-primary">Get Started</a>
                    <?php endif; ?>
                </div>
        ...
        <!-- Call-to-Action for visitors (only if not logged in) -->
        <?php if (!isLoggedIn()): ?>
            <section class="cta-section">
                ...
                <div class="cta-buttons">
                    <a href="/pages/register.php" class="btn btn-primary">Get Started</a>
                    <a href="/pages/login.php" class="btn btn-secondary-outline">Sign In</a>
                </div>
            </section>
        <?php endif; ?>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    likeButtons.forEach(button => {
        button.addEventListener('click', async function() {
            <?php if (!isLoggedIn()): ?>
                // Prompt non-logged users to log in before liking
            ...
            try {
                // Send AJAX request to like-blog.php API
                const formData = new FormData();
                formData.append('blog_id', blogId);

                const res = await fetch('/api/blog/like-blog.php', {
                    method: 'POST',
                    body: formData
                });
