    ...
    <div class="container">
        <div class="dashboard">
            ...
            <div class="dashboard-header">
                ...
                <a href="/pages/create-blog.php" class="btn btn-primary">Create New Blog</a>
            </div>
...
async function loadUserBlogs() {
    try {
        ...
        const response = await fetch(`/api/blog/read.php?user_id=${userId}`);
        ...
        if (data.success && data.blogs.length > 0) {
            ...
            blogContainer.innerHTML = data.blogs.map(blog => {
                ...
                const imageSrc = blog.image || '/assets/images/blog-placeholder.jpg';
                ...
                <div class="blog-item">
                    ...
                    <div class="blog-item-content">
                        <div class="blog-item-header">
                            <h3>
                                <a href="/pages/view-blog.php?id=${blog.id}">
                                    ${escapeHtml(blog.title)}
                                </a>
                            </h3>
                            <div class="blog-item-actions">
                                <a href="/pages/edit-blog.php?id=${blog.id}" 
